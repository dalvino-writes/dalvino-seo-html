export const siteCopy = {
  ...
  trustDeficit: {
    tagline: "Le problème · Trust Deficit",
  ...
  transformation: {
    tagline: "Avant et après",
    title: "La différence entre publier et construire.",
    before: {
      label: "Avant OAA",
      points: [
  ...
  contact: {
    ...
    subtitle:
      "Si votre programme de contenu ne produit pas de croissance organique cumulative, le Trust Deficit Audit est la première étape.",
    form: {
      name: "Nom",
      email: "Email",
      company: "Entreprise",
