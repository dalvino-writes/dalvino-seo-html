export const methodCopy = {
  ...
  layers: {
    tagline: "Ce que l’audit évalue",
    title: "Quatre couches structurelles de crédibilité",
  ...
  scoring: {
    tagline: "Comment fonctionne le scoring",
    title: "Un diagnostic structuré sur 20 points",
    body: [
      "Le Trust Deficit Audit utilise un modèle structuré de 20 points répartis sur quatre couches.",
      "Chaque couche contient cinq points d’évaluation.",
      "Chaque signal est évalué à partir d’éléments visibles, et non d’hypothèses.",
    ],
    classifications: [
      { label: "Critical Trust Gap", score: "0–7" },
      { label: "Significant Trust Gap", score: "8–11" },
      { label: "Moderate Trust Gap", score: "12–15" },
      { label: "Strong Trust Foundation", score: "16–20" },
    ],
    closing:
      "L’objectif n’est pas de réduire un site à un simple score. L’objectif est de rendre visibles les faiblesses structurelles de crédibilité afin de pouvoir les prioriser et agir dessus.",
  },

  diagnosis: {
    tagline: "Ce que l’audit diagnostique réellement",
    title: "Le Trust Gap",
    body: [
      "Chez Archoric, nous utilisons le terme Trust Gap pour décrire l’écart entre ce qu’un éditeur affirme et ce que son environnement informationnel démontre réellement.",
      "Cet écart ne vient presque jamais d’une seule page manquante ou d’une phrase faible.",
      "Il apparaît généralement lorsque plusieurs couches de crédibilité sont sous-développées en même temps : langage réglementaire vague, détail opérationnel limité, architecture fragmentée et validation insuffisante.",
      "L’audit est conçu pour rendre ce schéma visible.",
    ],
  },
  ...
  deliverable: {
    ...
    closing:
      "Le résultat est une vision plus claire des raisons pour lesquelles la confiance sous-performe sur votre site, et de ce qu’il faut renforcer en priorité.",
  },

  flow: {
    tagline: "Ce qui se passe après l’audit",
    title: "Là où l’audit mène",
    steps: [
      "Trust Gap Scoring Methodology",
      "Trust Deficit Audit",
      "Layered Trust Defense Architecture",
  ...
  clarification: {
    tagline: "Clarification importante",
    title: "Ce que cet audit fait et ne fait pas",
    body: [
      "Le Trust Deficit Audit évalue des signaux de crédibilité visibles.",
      "Il ne vérifie pas la conformité juridique interne d’une entreprise, son implémentation de sécurité interne ou ses processus privés.",
      "Il évalue à quel point la confiance est démontrée clairement à des évaluateurs externes, y compris les acheteurs, les moteurs de recherche et les environnements de découverte pilotés par l’IA.",
    ],
  },

  cta: {
    tagline: "Commencez par le diagnostic",
    title: "La structure avant le volume.",
    body:
      "Si votre site publie du contenu mais n’atteint toujours pas le niveau de confiance attendu par votre marché, le problème n’est peut-être pas le volume. Il est peut-être structurel.",
    cta: "Obtenir votre Trust Deficit Audit",
  },
};